...
namespace Hypermarket_Admin_Management_Tool._0_View
{
    ...
    public partial class AddEditStaff : Form
    {
        ...
        public AddEditStaff(string name, string staffID, DateTime renewPasswordDate, DateTime dateOfBirth, DateTime joinDate, string gender, string position, string contact, bool defaultPassword, bool blocked)
        {
            InitializeComponent();
            txtName.Text = name;
            txtEmail.Text = staffID;
        ...
        private void PerformAddStaff()
        {
            try
            {
                ...
                {
                    mainController.AddStaff(txtEmail.Text, txtName.Text, dtpDoB.Value.Date, dtpJoinDate.Value.Date, cbGender.Text, cbPosition.Text, txtContact.Text);
                    this.Close();
                }
            }
            catch
        ...
        private void PerformEditStaff()
        {
            try
            {
                ...
                {
                    mainController.UpdateStaff(txtEmail.Text, txtContact.Text, cbPosition.Text, chkDefaultPsw.Checked, chkBlocked.Checked);
